...
public class TestMatrice
{
	 ...
	 * fonctionnel L'affichage final devra être proche de celui-ci : 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11
	 * 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 13 13 13 13 13 13 13 13 13 13 11 11 11 11 11
	 * 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 On teste
	 * aussi la méthode getBackgroundAt
	 * 
	 * @param args
	...
	public static void main(String[] args) throws CoordonneesMatriceException
	{
		...
		int[] parcours = new int[]
			{ Chemin.DROITE, Chemin.DROITE, Chemin.DROITE, Chemin.DROITE, Chemin.DROITE, Chemin.DROITE, Chemin.DROITE,
					Chemin.DROITE, Chemin.DROITE, Chemin.DROITE };
		Chemin chemin = new Chemin(pointDepart, parcours);
		int[][] background = new int[][]
			{
						{ Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE,
								Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE },
						{ Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE,
								Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE },
						{ Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE,
								Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE },
						{ Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE,
								Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE },
						{ Matrice.ROUTE, Matrice.ROUTE, Matrice.ROUTE, Matrice.ROUTE, Matrice.ROUTE, Matrice.ROUTE,
								Matrice.ROUTE, Matrice.ROUTE, Matrice.ROUTE, Matrice.ROUTE },
						{ Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE,
								Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE },
						{ Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE,
								Matrice.TERRE, Matrice.TERRE, Matrice.TERRE, Matrice.TERRE },
